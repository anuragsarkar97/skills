...
for (const required of [
  ...
  "knowledge/golang/go-engineering.md",
  "knowledge/react/react-engineering.md",
  "knowledge/python/python-scripting.md",
  "knowledge/kubernetes/kubernetes-operations.md",
  "knowledge/cloud/aws-azure-architecture.md",
